...
option(ENABLE_LIBEVENT "option for libevent" OFF)
if (ENABLE_LIBEVENT)
    ...
    if (libevent_FOUND)
        ...
        add_definitions(-DENABLE_LIBEVENT)
        include_directories(${libevent_INCLUDE_DIRS})
        if ("${Tools_Other_Project}" STREQUAL "ON")
            message(STATUS "libevent library status:")
            message(STATUS "    ${libevent_VERSION}")
            message(STATUS "    libraries: ${libevent_LIBRARIES}")
            message(STATUS "    libraries: ${LIBEVENT_LIBRARIES}")
            message(STATUS "    lib_dir: ${libevent_LIBRARY_DIRS}")
            message(STATUS "    include path: ${libevent_INCLUDE_DIRS}")
            message(STATUS "    include path: ${LIBEVENT_INCLUDE_DIRS}")
        endif ()
        include_directories(${libevent_INCLUDE_DIRS} ${LIBEVENT_INCLUDE_DIRS})
