...
option(ENABLE_X11 "option for X11" ON)
if (ENABLE_X11)
    find_package(X11)
    if (X11_FOUND)
...
option(ENABLE_OPENCV "option for OpenCV" ON)
if (ENABLE_OPENCV)
else ()
...
option(ENABLE_CURL "option for CURL" ON)
if (ENABLE_CURL)
else ()
    set(CURL_ENABLE OFF)
endif ()
if (CURL_ENABLE)
    ...
    if (CURL_FOUND)
        ...
        add_definitions(-DCURL_ENABLE=ON -DENABLE_CURL=ON)
    else ()
        set(${CURL_LIBRARIES} "")
    endif ()
ENDIF (CURL_ENABLE)
