...
if (clangToolsExample OR "${Tools_Other_Project}" STREQUAL "ON")
    ...
    add_executable(popen_demo Example/popen_demo.cpp)
    add_executable(test_subprocess Example/test_subprocess.cc)
    add_executable(condition_variable Example/condition_variable.cpp)
    ...
    target_link_libraries(popen_demo ${libTools_LIBRARIES} ${dl_LIBRARIES})
    target_link_libraries(test_subprocess ${libTools_LIBRARIES} ${dl_LIBRARIES})

    option(ENABLE_FILENAME "option for FILENAME" ON)
    if (ENABLE_FILENAME)
        redefine_file_macro(test_subprocess)
        ...
        redefine_file_macro(popen_demo)
    ...
    install(TARGETS http_Demo logger_Demo thread_pool_demo tinyxml2_demo json_demo memory_share_demo pipe_demo popen_demo test_subprocess
